        ...
        <>
            ...
            <div className='max-w-7xl mx-auto my-10 px-4'>
                ...
                <div className='my-4 space-y-2'>
                    ...
                    <h1 className='font-bold'>Experience: <span className='pl-2 font-normal text-gray-800'>{singleJob?.experienceLevel} yrs</span></h1>
                    <h1 className='font-bold'>Salary: <span className='pl-2 font-normal text-gray-800'>{singleJob?.salary}</span></h1>
